...
//   const screemHeight = window.innerHeight;
//   const numCols = Math.ceil(screenWidth / BLOCK_SIZE);
//   const numRows = Math.ceil(screemHeight / BLOCK_SIZE);
//   const numBlocks = numCols * numRows;
//   for (let i = 0; i < numBlocks; i++) {
//     const block = document.createElement("div");
//     block.classList.add("block");
//     block.dataset.index = i;
//     blocksRef.value.appendChild(block);
//   }
//   return { numCols, numBlocks };
// };

// const highlightBlock = (e) => {
//   if (blocksRef.value) {
//     // console.log(e);
//     const { numCols } = window.blockInfo;
//     // console.log(numCols);
//     const rect = blocksRef.value.getBoundingClientRect();

//     const x = e.clientX - rect.left;
//     const y = e.clientY - rect.top;
//     const col = Math.ceil(x / BLOCK_SIZE);
//     const row = Math.floor(y / BLOCK_SIZE);
//     const index = row * numCols + col;
//     console.log(col, row, index);

//     const block = blocksRef.value.children[index];
//     if (block) {
...
onMounted(() => {
  try {
    ...
    return () => {
      ...
      blocksRef.value?.removeEventListener("mousemove", highlightBlock);
...
<template>
  <div>
    ...
    <div class="blocks-container">
      <div ref="blocksRef" class="blocks"></div>
    </div>
  </div>
</template>
